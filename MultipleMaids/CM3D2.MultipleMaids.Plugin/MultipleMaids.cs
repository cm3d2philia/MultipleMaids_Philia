...
namespace CM3D2.MultipleMaids.Plugin
{
    ...
    public partial class MultipleMaids : PluginBase
	{
        ...
        public MultipleMaids() : base()
        {
            ...
            waku = null;
            waku2 = null;
            sortList = new List<MultipleMaids.SortItem>();
            sortListMy = new List<MultipleMaids.SortItemMy>();
            itemDataList = new List<MultipleMaids.ItemData>();
            itemDataListMod = new List<MultipleMaids.ItemData>();
            itemDataListNMod = new List<MultipleMaids.ItemData>();
            isIdx1 = false;
            isIdx2 = false;
            isIdx3 = false;
            isIdx4 = false;
